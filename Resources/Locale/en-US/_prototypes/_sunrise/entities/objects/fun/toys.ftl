...
ent-PlushieSansaMontanelli = Sansa Montanelli
    .desc = { ent-BasePlushie.desc }
ent-PlushieSeya = Plush Seya-Tanaka
    .desc = An ordinary plush vulpkanin with dark fur, but it seems to be watching you.
ent-PlushieValancius = Plush Isabella Von Valancius
    .desc = A plush toy of the IAA, smelling of bureaucracy, corporate law, and cats.
ent-PlushieJin = Plush Jin-Dimepa
    .desc = Will save you from anywhere in the world if you're his friend or girlfriend, loves his job but loves Olivia even more, black because he smokes a lot.
ent-PlushieAnna = Plush Anna Solovyova
    .desc = She loves her job and isn't shy about expressing her affection for friends, generously showering them with joyful "meows!".
ent-PlushieDanis = Plush Danis Shelby
    .desc = A plush paramedic with a non-plush personality. The toy has an inscription: "10% of the time working, 90% - trying to get the CMO".
ent-PlushieKaterina = Plush Katerina Krestova
    .desc = A plush toy of the Chief Medical Officer, smells of ironed felinids.
ent-PlushieNian = Plush Alfea Cometraider
    .desc = A plush nian who is proud of her beauty: the pattern on her wings and antennae! Loves to chirp.
ent-PlushieNika = Plush Nika Bragina
    .desc = If you die when she's on shift, beware - for once you fall into the hands of this arcana, you'll become a felinid.
ent-PlushieSanya = Plush Sanya Krestov
    .desc = Former Sanya Serenky. Responsible for mass mouse genocide, and his bag is full of contraband. Owns two vulps and loves to purr for Kate.
ent-PlushieVelma = Plush Eustachius Gorky
    .desc = A slightly alternatively gifted researcher. Sometimes, in the evenings, he repeats: "Have you seen Kainar?".
ent-PlushieSunny = Plush Sunny Solnyshkova
    .desc = A dazzlingly shining pink sun from the strategic reserve of pink vulps NT.
ent-PlushieTurchin = Plush Turin Kapustin
    .desc = A grumpy, eternally beer-thirsty dwarf botanist, don't ask him to grow weed. Smells of deus ambrosia and alcohol breath.
